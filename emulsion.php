...
<body>
    <section id="top">
        <div class="container-fluid">
            <div class="row">
                <h2>EMULSIONS</h2>
                <span>Indulge in the sensory experience of Dior emulsions, the skincare products with <br> a light, fluid texture. <br>
                Discover Capture Dreamskin Care & Perfect, the global age-defying emulsion <br> and perfect skin creator, to integrate into your skincare routine.</span>
